...
% The output 'vocab' should be maxtrix vocab_size x 128. Each row is a cluster
...
[centers, assigments] }= vl_kmeans(X, K)
...
% many SIFT as you will in get_bags_of_sift.m, because you're only
